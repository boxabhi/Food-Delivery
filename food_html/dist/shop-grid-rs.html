...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Shop grid right sidebar
    </title>
    <!-- SEO Meta Tags-->
      ...
      <div class="row">
        ...
        <section class="col-lg-8">
          ...
          <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
            ...
            <div class="d-none d-sm-flex pb-3"><a class="btn btn-icon nav-link-style bg-light text-dark disabled opacity-100 mr-2" href="#"><i class="czi-view-grid"></i></a><a class="btn btn-icon nav-link-style nav-link-light" href="shop-list-rs.html"><i class="czi-view-list"></i></a></div>
          </div>
          <!-- Products grid-->
          <div class="row mx-n2">
            <!-- Product-->
